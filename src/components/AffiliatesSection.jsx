      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <AnimatedSection animation="fadeInUp" delay={400}>
          <div className="flex justify-center">
            <button className="bg-blue-500 text-white px-6 py-1 rounded-full font-medium text-lg hover:bg-blue-600 transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
              Take Me There
            </button>
          </div>
        </AnimatedSection>

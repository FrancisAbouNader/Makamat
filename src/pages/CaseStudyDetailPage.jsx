    ...
    return (
        <>
            ...
            <main className="min-h-screen relative bg-white overflow-hidden">
                ...
                {/* Frosted Glass Card */}
                <div className="relative z-10 flex justify-center items-center pt-24 md:pt-32 pb-16 md:pb-20 px-4 sm:px-6 lg:px-8">
                    <AnimatedSection animation="scaleIn" delay={200}>
                        <div className="max-w-3xl w-full bg-white/60 backdrop-blur-lg rounded-[80px] md:rounded-[150px] p-8 md:p-20 space-y-6 md:space-y-8">
                            ...
                            {/* Title */}
                            <h1 className="text-lg md:text-xl font-bold text-gray-900 leading-tight text-center lg:text-left">
                                {study.title}
                            </h1>

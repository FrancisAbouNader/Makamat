...
const GBMSPage = () => {
    ...
    const teamMembers = [
        ...
        { id: 'ahmed-hassan', name: 'Dr. Ahmed Hassan', title: 'Medical Director', image: '/human-2.png' },
        { id: 'sarah-al-rashid', name: 'Sarah Al-Rashid', title: 'Technical Support Lead', image: '/human-3.png' }
    ];
                                ...
                                <div className="order-2 lg:order-1">
                                    <div className="relative">
                                        <img
                                            ...
                                            className="w-full h-64 md:h-80 lg:h-96 object-cover rounded-[20px] md:rounded-[40px]"
                                        />
                                    </div>
                                </div>
                            </AnimatedSection>
                                ...
                                <div className="order-2 lg:order-1">
                                    <div className="relative flex justify-center lg:justify-end">
                                        <img
                                            ...
                                            alt="Medical professionals in surgery"
                                            className="w-3/4 h-48 md:h-64 object-cover rounded-[20px] md:rounded-[40px]"
                                        />
                                    </div>
                                </div>
                            </AnimatedSection>
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div ref={teamRef} className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                            {teamMembers.map((member, index) => (
                                <div 
                                    key={index}
                                    className={`rounded-2xl p-6 md:p-8 transition-all duration-700 transform hover:scale-105 hover:shadow-lg ${
                    ...
                    <AnimatedSection animation="fadeInUp" delay={200}>
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                ...
                                <button className="bg-blue-500 hover:bg-blue-600 text-white px-6 md:px-8 py-2 md:py-3 rounded-full font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
                                    Learn More
                                </button>
                            </div>
                        </div>

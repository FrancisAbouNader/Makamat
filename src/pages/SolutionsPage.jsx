            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div ref={cardsRef} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                {solutionCards.map((card, idx) => (
                    <div
                        key={idx}
                        className={`rounded-xl min-h-[300px] p-6 bg-gradient-to-br from-yellow-200 via-orange-300 to-red-200 shadow-md hover:shadow-xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 ${
              ...
              <AnimatedSection animation="fadeInUp" delay={600}>
                <div className="mt-20 text-left">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <button className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-1 rounded-full font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
                      Learn More
                    </button>
                  </div>
                </div>

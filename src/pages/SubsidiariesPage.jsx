        ...
        <>
            ...
            <main className="min-h-screen bg-white">
                ...
                <section className="relative h-screen flex items-center justify-center overflow-hidden">
                    ...
                    {/* Content */}
                    <div className="relative z-10 max-w-4xl text-black mb-[200px] ml-auto px-4 sm:px-6 lg:px-8 text-start">
                        <h1 className="text-5xl md:text-6xl lg:text-4xl font-bold mb-8">
                            Subsidiaries
                        </h1>
                        <p className="text-lg md:text-lg leading-relaxed max-w-3xl">
                ...
                <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="relative max-w-4xl mx-auto">
                            ...
                            <div className="relative bg-white rounded-[60px] p-12 shadow-lg">
                                {/* Gradient Border Effect */}
                                <div className="absolute inset-0 rounded-[60px] p-10 blur-md bg-gradient-to-r from-teal-300 via-blue-300 to-teal-300">
                                    <div className="bg-white rounded-[56px] h-full w-full"></div>
                                </div>
                                ...
                                <div className="relative z-10 space-y-8 p-10">
                                    <div className="flex items-start space-x-6">
                                        ...
                                        <div>
                                            <h3 className="text-xl font-bold text-gray-900 mb-2">Expertise that Delivers</h3>
                                    ...
                                    <div className="flex items-start space-x-6">
                                        ...
                                        <div>
                                            <h3 className="text-xl font-bold text-gray-900 mb-2">Strong Regional Reach</h3>
                                            <p className="text-gray-600 leading-relaxed">
                                    ...
                                    <div className="flex items-start space-x-6">
                                        ...
                                        <div>
                                            <h3 className="text-xl font-bold text-gray-900 mb-2">Trusted Operations</h3>
                                            <p className="text-gray-600 leading-relaxed">
                                    ...
                                    <div className="flex items-start space-x-6">
                                        ...
                                        <div>
                                            <h3 className="text-xl font-bold text-gray-900 mb-2">Tech-Focused Innovation</h3>
                                            <p className="text-gray-600 leading-relaxed">
                                    ...
                                    <div className="flex items-start space-x-6">
                                        ...
                                        <div>
                                            <h3 className="text-xl font-bold text-gray-900 mb-2">Ecosystem for Growth</h3>
                                            <p className="text-gray-600 leading-relaxed">
